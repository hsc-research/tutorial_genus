...
## Results
As you go along this tutorial, in many places you will be asked to write down your results. You can use a table for that. The following table is a suggestion, where each design we try is a new row. Feel free to give the designs some meaningful names:
